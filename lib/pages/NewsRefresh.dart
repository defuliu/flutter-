...
class NewsRefreshPage extends StatefulWidget {
  NewsRefreshPage({Key key}) : super(key: key);

  @override
  _NewsRefreshPageState createState() => _NewsRefreshPageState();
}

class _NewsRefreshPageState extends State<NewsRefreshPage> {
  int _page = 1;
  List _list = [];
